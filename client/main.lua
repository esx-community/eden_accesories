...
AddEventHandler('eden_accesories:silencer', function(duration)
    ...
    local currentWeaponHash = GetSelectedPedWeapon(ped)
		if used < silencieux then
			...
			if currentWeaponHash == GetHashKey("WEAPON_PISTOL") then
		  		 ...
		  		 ESX.ShowNotification(("You have just equipped yourself with a silencer. It will be necessary to re-equip it with every return in town.")) 
		  		 	used = used + 1
	...
	used = used + 1
		  		  ...
		  		  ESX.ShowNotification(("You are not holding a weapon or your weapon does not support a silencer."))
		  		
			end
			else
					  		 ESX.ShowNotification(("You used all your silencers on all your weapons.")) 
...
AddEventHandler('eden_accesories:flashlight', function(duration)
	...
	used2 = used2 + 1
		  		  ...
		  		  ESX.ShowNotification(("You are not holding a weapon or your weapon does not support a flashlight."))
		  		
			end
		else
				  		  ESX.ShowNotification(("You used all your flashlights on your weapons."))
...
AddEventHandler('eden_accesories:grip', function(duration)
    ...
    local currentWeaponHash = GetSelectedPedWeapon(ped)
		if used3 < grip then
			...
			if currentWeaponHash == GetHashKey("WEAPON_COMBATPDW") then
		  		 ...
		  		 ESX.ShowNotification(("You have just equipped yourself with a grip. It will be necessary to re-equip it with every return in town.")) 
		  				used3 = used3 + 1
	...
	used3 = used3 + 1
		  		  ...
		  		  ESX.ShowNotification(("You are not holding a weapon or your weapon does not support a grip."))
		  		
			end
		else
				  		  ESX.ShowNotification(("You used all your grips on your weapons."))
		end
end)
...
AddEventHandler('eden_accesories:yusuf', function(duration)
    ...
    local currentWeaponHash = GetSelectedPedWeapon(ped)
		if used4 < yusuf then
			...
			if currentWeaponHash == GetHashKey("WEAPON_PISTOL") then
		  		 ...
		  		 ESX.ShowNotification(("You have just adjusted your new weapon skin. It will be necessary to re-equip it with every return in town.")) 
		  		 	used4 = used4 + 1
	...
	used4 = used4 + 1
		  		  ...
		  		  ESX.ShowNotification(("You are not holding a weapon or your weapon does not support a luxury look."))
		  		
			end
		else
				  		  ESX.ShowNotification(("You have used all your luxury skins on your weapons"))
